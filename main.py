...
async def analyze(
    ...
    # =========================================================================
    # Step 10: Generate AI memo (VALIDITY-GOVERNED)
    # =========================================================================
    memo = None
    if request.include_ai_memo:
        logger.info("Generating validity-governed AI memo...")
        ...
        if openai_key:
            memo = await generate_memo(
                ...
                api_key=openai_key,
                model="gpt-4o",
                validity_data=validity_output.to_dict(),  # Pass validity to govern memo
            )
